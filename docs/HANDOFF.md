...
기준 브랜치는 `feat/spec-gaps`, 시작 시점 HEAD는 `40e2c6c`이다. 작업 트리는 미커밋 상태이며 배포는 하지 않았다.
...
- 좌표 대조를 마친 화면은 A1·C1·D1·E1·H1이다. **B1·F1·F2·G1·H2·B9·J1은 좌표 대조를 하지 않았다.**
...
3. 좌표 대조를 하지 않은 7개 화면(B1·F1·F2·G1·H2·B9·J1)을 같은 방식으로 대조한다.
