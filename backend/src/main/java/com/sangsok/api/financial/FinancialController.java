...
public class FinancialController {
    private final FinancialItemRepository items; private final CaseService access; private final CaseRepository cases;private final PiiTextMasker masker;
    public FinancialController(FinancialItemRepository items,CaseService access,CaseRepository cases,PiiTextMasker masker){this.items=items;this.access=access;this.cases=cases;this.masker=masker;}
